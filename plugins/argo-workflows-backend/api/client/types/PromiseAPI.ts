...
export class PromiseArchivedWorkflowServiceApi {
     ...
     * @param namespace 
     */
    public archivedWorkflowServiceDeleteArchivedWorkflow(uid: string, namespace?: string, _options?: Configuration): Promise<any> {
        const result = this.api.archivedWorkflowServiceDeleteArchivedWorkflow(uid, namespace, _options);
     ...
     * @param name 
     */
    public archivedWorkflowServiceGetArchivedWorkflow(uid: string, namespace?: string, name?: string, _options?: Configuration): Promise<IoArgoprojWorkflowV1alpha1Workflow> {
        const result = this.api.archivedWorkflowServiceGetArchivedWorkflow(uid, namespace, name, _options);
        return result.toPromise();
    }
     ...
     * @param namespace 
     */
    public archivedWorkflowServiceListArchivedWorkflowLabelKeys(namespace?: string, _options?: Configuration): Promise<IoArgoprojWorkflowV1alpha1LabelKeys> {
        const result = this.api.archivedWorkflowServiceListArchivedWorkflowLabelKeys(namespace, _options);
        return result.toPromise();
    }
     ...
     * @param namespace 
     */
    public archivedWorkflowServiceListArchivedWorkflows(listOptionsLabelSelector?: string, listOptionsFieldSelector?: string, listOptionsWatch?: boolean, listOptionsAllowWatchBookmarks?: boolean, listOptionsResourceVersion?: string, listOptionsResourceVersionMatch?: string, listOptionsTimeoutSeconds?: string, listOptionsLimit?: string, listOptionsContinue?: string, namePrefix?: string, namespace?: string, _options?: Configuration): Promise<IoArgoprojWorkflowV1alpha1WorkflowList> {
        const result = this.api.archivedWorkflowServiceListArchivedWorkflows(listOptionsLabelSelector, listOptionsFieldSelector, listOptionsWatch, listOptionsAllowWatchBookmarks, listOptionsResourceVersion, listOptionsResourceVersionMatch, listOptionsTimeoutSeconds, listOptionsLimit, listOptionsContinue, namePrefix, namespace, _options);
        return result.toPromise();
    }
     ...
     * @param body 
     */
    public archivedWorkflowServiceResubmitArchivedWorkflow(uid: string, body: IoArgoprojWorkflowV1alpha1ResubmitArchivedWorkflowRequest, _options?: Configuration): Promise<IoArgoprojWorkflowV1alpha1Workflow> {
        const result = this.api.archivedWorkflowServiceResubmitArchivedWorkflow(uid, body, _options);
        return result.toPromise();
    }
     ...
     * @param body 
     */
    public archivedWorkflowServiceRetryArchivedWorkflow(uid: string, body: IoArgoprojWorkflowV1alpha1RetryArchivedWorkflowRequest, _options?: Configuration): Promise<IoArgoprojWorkflowV1alpha1Workflow> {
        const result = this.api.archivedWorkflowServiceRetryArchivedWorkflow(uid, body, _options);
        return result.toPromise();
    }
...
export class PromiseArtifactServiceApi {
     ...
     */
    public artifactServiceGetArtifactFile(namespace: string, idDiscriminator: 'workflow' | 'archived-workflows ', id: string, nodeId: string, artifactName: string, artifactDiscriminator: 'outputs', _options?: Configuration): Promise<HttpFile> {
        const result = this.api.artifactServiceGetArtifactFile(namespace, idDiscriminator, id, nodeId, artifactName, artifactDiscriminator, _options);
        return result.toPromise();
    }
     ...
     * @param artifactName 
     */
    public artifactServiceGetInputArtifact(namespace: string, name: string, nodeId: string, artifactName: string, _options?: Configuration): Promise<HttpFile> {
        const result = this.api.artifactServiceGetInputArtifact(namespace, name, nodeId, artifactName, _options);
        return result.toPromise();
    }
     ...
     * @param artifactName 
     */
    public artifactServiceGetInputArtifactByUID(uid: string, nodeId: string, artifactName: string, _options?: Configuration): Promise<HttpFile> {
        const result = this.api.artifactServiceGetInputArtifactByUID(uid, nodeId, artifactName, _options);
        return result.toPromise();
    }
     ...
     * @param artifactName 
     */
    public artifactServiceGetOutputArtifact(namespace: string, name: string, nodeId: string, artifactName: string, _options?: Configuration): Promise<HttpFile> {
        const result = this.api.artifactServiceGetOutputArtifact(namespace, name, nodeId, artifactName, _options);
        return result.toPromise();
    }
     ...
     * @param artifactName 
     */
    public artifactServiceGetOutputArtifactByUID(uid: string, nodeId: string, artifactName: string, _options?: Configuration): Promise<HttpFile> {
        const result = this.api.artifactServiceGetOutputArtifactByUID(uid, nodeId, artifactName, _options);
        return result.toPromise();
    }
...
export class PromiseClusterWorkflowTemplateServiceApi {
     ...
     * @param body 
     */
    public clusterWorkflowTemplateServiceCreateClusterWorkflowTemplate(body: IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplateCreateRequest, _options?: Configuration): Promise<IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplate> {
        const result = this.api.clusterWorkflowTemplateServiceCreateClusterWorkflowTemplate(body, _options);
        return result.toPromise();
    }
     ...
     */
    public clusterWorkflowTemplateServiceDeleteClusterWorkflowTemplate(name: string, deleteOptionsGracePeriodSeconds?: string, deleteOptionsPreconditionsUid?: string, deleteOptionsPreconditionsResourceVersion?: string, deleteOptionsOrphanDependents?: boolean, deleteOptionsPropagationPolicy?: string, deleteOptionsDryRun?: Array<string>, _options?: Configuration): Promise<any> {
        const result = this.api.clusterWorkflowTemplateServiceDeleteClusterWorkflowTemplate(name, deleteOptionsGracePeriodSeconds, deleteOptionsPreconditionsUid, deleteOptionsPreconditionsResourceVersion, deleteOptionsOrphanDependents, deleteOptionsPropagationPolicy, deleteOptionsDryRun, _options);
        return result.toPromise();
    }
     ...
     */
    public clusterWorkflowTemplateServiceGetClusterWorkflowTemplate(name: string, getOptionsResourceVersion?: string, _options?: Configuration): Promise<IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplate> {
        const result = this.api.clusterWorkflowTemplateServiceGetClusterWorkflowTemplate(name, getOptionsResourceVersion, _options);
        return result.toPromise();
    }
     ...
     * @param body 
     */
    public clusterWorkflowTemplateServiceLintClusterWorkflowTemplate(body: IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplateLintRequest, _options?: Configuration): Promise<IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplate> {
        const result = this.api.clusterWorkflowTemplateServiceLintClusterWorkflowTemplate(body, _options);
        return result.toPromise();
    }
     ...
     * @param body 
     */
    public clusterWorkflowTemplateServiceUpdateClusterWorkflowTemplate(name: string, body: IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplateUpdateRequest, _options?: Configuration): Promise<IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplate> {
        const result = this.api.clusterWorkflowTemplateServiceUpdateClusterWorkflowTemplate(name, body, _options);
        return result.toPromise();
    }
...
export class PromiseCronWorkflowServiceApi {
     ...
     * @param body 
     */
    public cronWorkflowServiceCreateCronWorkflow(namespace: string, body: IoArgoprojWorkflowV1alpha1CreateCronWorkflowRequest, _options?: Configuration): Promise<IoArgoprojWorkflowV1alpha1CronWorkflow> {
        const result = this.api.cronWorkflowServiceCreateCronWorkflow(namespace, body, _options);
        return result.toPromise();
    }
    ...
    public cronWorkflowServiceDeleteCronWorkflow(namespace: string, name: string, deleteOptionsGracePeriodSeconds?: string, deleteOptionsPreconditionsUid?: string, deleteOptionsPreconditionsResourceVersion?: string, deleteOptionsOrphanDependents?: boolean, deleteOptionsPropagationPolicy?: string, deleteOptionsDryRun?: Array<string>, _options?: Configuration): Promise<any> {
        const result = this.api.cronWorkflowServiceDeleteCronWorkflow(namespace, name, deleteOptionsGracePeriodSeconds, deleteOptionsPreconditionsUid, deleteOptionsPreconditionsResourceVersion, deleteOptionsOrphanDependents, deleteOptionsPropagationPolicy, deleteOptionsDryRun, _options);
        return result.toPromise();
    }
     ...
     * @param getOptionsResourceVersion resourceVersion sets a constraint on what resource versions a request may be served from. See https://kubernetes.io/docs/reference/using-api/api-concepts/#resource-versions for details.  Defaults to unset +optional
     */
    public cronWorkflowServiceGetCronWorkflow(namespace: string, name: string, getOptionsResourceVersion?: string, _options?: Configuration): Promise<IoArgoprojWorkflowV1alpha1CronWorkflow> {
        const result = this.api.cronWorkflowServiceGetCronWorkflow(namespace, name, getOptionsResourceVersion, _options);
        return result.toPromise();
    }
     ...
     * @param body 
     */
    public cronWorkflowServiceLintCronWorkflow(namespace: string, body: IoArgoprojWorkflowV1alpha1LintCronWorkflowRequest, _options?: Configuration): Promise<IoArgoprojWorkflowV1alpha1CronWorkflow> {
        const result = this.api.cronWorkflowServiceLintCronWorkflow(namespace, body, _options);
        return result.toPromise();
    }
     ...
     * @param listOptionsContinue The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \&quot;next key\&quot;.  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.
     */
    public cronWorkflowServiceListCronWorkflows(namespace: string, listOptionsLabelSelector?: string, listOptionsFieldSelector?: string, listOptionsWatch?: boolean, listOptionsAllowWatchBookmarks?: boolean, listOptionsResourceVersion?: string, listOptionsResourceVersionMatch?: string, listOptionsTimeoutSeconds?: string, listOptionsLimit?: string, listOptionsContinue?: string, _options?: Configuration): Promise<IoArgoprojWorkflowV1alpha1CronWorkflowList> {
        const result = this.api.cronWorkflowServiceListCronWorkflows(namespace, listOptionsLabelSelector, listOptionsFieldSelector, listOptionsWatch, listOptionsAllowWatchBookmarks, listOptionsResourceVersion, listOptionsResourceVersionMatch, listOptionsTimeoutSeconds, listOptionsLimit, listOptionsContinue, _options);
        return result.toPromise();
    }
     ...
     * @param body 
     */
    public cronWorkflowServiceResumeCronWorkflow(namespace: string, name: string, body: IoArgoprojWorkflowV1alpha1CronWorkflowResumeRequest, _options?: Configuration): Promise<IoArgoprojWorkflowV1alpha1CronWorkflow> {
        const result = this.api.cronWorkflowServiceResumeCronWorkflow(namespace, name, body, _options);
        return result.toPromise();
    }
     ...
     * @param body 
     */
    public cronWorkflowServiceSuspendCronWorkflow(namespace: string, name: string, body: IoArgoprojWorkflowV1alpha1CronWorkflowSuspendRequest, _options?: Configuration): Promise<IoArgoprojWorkflowV1alpha1CronWorkflow> {
        const result = this.api.cronWorkflowServiceSuspendCronWorkflow(namespace, name, body, _options);
        return result.toPromise();
    }
     ...
     * @param body 
     */
    public cronWorkflowServiceUpdateCronWorkflow(namespace: string, name: string, body: IoArgoprojWorkflowV1alpha1UpdateCronWorkflowRequest, _options?: Configuration): Promise<IoArgoprojWorkflowV1alpha1CronWorkflow> {
        const result = this.api.cronWorkflowServiceUpdateCronWorkflow(namespace, name, body, _options);
        return result.toPromise();
    }
...
export class PromiseEventServiceApi {
     ...
     * @param listOptionsContinue The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \&quot;next key\&quot;.  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.
     */
    public eventServiceListWorkflowEventBindings(namespace: string, listOptionsLabelSelector?: string, listOptionsFieldSelector?: string, listOptionsWatch?: boolean, listOptionsAllowWatchBookmarks?: boolean, listOptionsResourceVersion?: string, listOptionsResourceVersionMatch?: string, listOptionsTimeoutSeconds?: string, listOptionsLimit?: string, listOptionsContinue?: string, _options?: Configuration): Promise<IoArgoprojWorkflowV1alpha1WorkflowEventBindingList> {
        const result = this.api.eventServiceListWorkflowEventBindings(namespace, listOptionsLabelSelector, listOptionsFieldSelector, listOptionsWatch, listOptionsAllowWatchBookmarks, listOptionsResourceVersion, listOptionsResourceVersionMatch, listOptionsTimeoutSeconds, listOptionsLimit, listOptionsContinue, _options);
        return result.toPromise();
    }
     ...
     */
    public eventServiceReceiveEvent(namespace: string, discriminator: string, body: any, _options?: Configuration): Promise<any> {
        const result = this.api.eventServiceReceiveEvent(namespace, discriminator, body, _options);
        return result.toPromise();
    }
...
export class PromiseEventSourceServiceApi {
     ...
     * @param body 
     */
    public eventSourceServiceCreateEventSource(namespace: string, body: EventsourceCreateEventSourceRequest, _options?: Configuration): Promise<IoArgoprojEventsV1alpha1EventSource> {
        const result = this.api.eventSourceServiceCreateEventSource(namespace, body, _options);
        return result.toPromise();
    }
    ...
    public eventSourceServiceDeleteEventSource(namespace: string, name: string, deleteOptionsGracePeriodSeconds?: string, deleteOptionsPreconditionsUid?: string, deleteOptionsPreconditionsResourceVersion?: string, deleteOptionsOrphanDependents?: boolean, deleteOptionsPropagationPolicy?: string, deleteOptionsDryRun?: Array<string>, _options?: Configuration): Promise<any> {
        const result = this.api.eventSourceServiceDeleteEventSource(namespace, name, deleteOptionsGracePeriodSeconds, deleteOptionsPreconditionsUid, deleteOptionsPreconditionsResourceVersion, deleteOptionsOrphanDependents, deleteOptionsPropagationPolicy, deleteOptionsDryRun, _options);
        return result.toPromise();
    }
     ...
     * @param name 
     */
    public eventSourceServiceGetEventSource(namespace: string, name: string, _options?: Configuration): Promise<IoArgoprojEventsV1alpha1EventSource> {
        const result = this.api.eventSourceServiceGetEventSource(namespace, name, _options);
        return result.toPromise();
    }
     ...
     * @param listOptionsContinue The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \&quot;next key\&quot;.  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.
     */
    public eventSourceServiceListEventSources(namespace: string, listOptionsLabelSelector?: string, listOptionsFieldSelector?: string, listOptionsWatch?: boolean, listOptionsAllowWatchBookmarks?: boolean, listOptionsResourceVersion?: string, listOptionsResourceVersionMatch?: string, listOptionsTimeoutSeconds?: string, listOptionsLimit?: string, listOptionsContinue?: string, _options?: Configuration): Promise<IoArgoprojEventsV1alpha1EventSourceList> {
        const result = this.api.eventSourceServiceListEventSources(namespace, listOptionsLabelSelector, listOptionsFieldSelector, listOptionsWatch, listOptionsAllowWatchBookmarks, listOptionsResourceVersion, listOptionsResourceVersionMatch, listOptionsTimeoutSeconds, listOptionsLimit, listOptionsContinue, _options);
        return result.toPromise();
    }
     ...
     * @param body 
     */
    public eventSourceServiceUpdateEventSource(namespace: string, name: string, body: EventsourceUpdateEventSourceRequest, _options?: Configuration): Promise<IoArgoprojEventsV1alpha1EventSource> {
        const result = this.api.eventSourceServiceUpdateEventSource(namespace, name, body, _options);
        return result.toPromise();
    }
     ...
     * @param listOptionsContinue The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \&quot;next key\&quot;.  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.
     */
    public eventSourceServiceWatchEventSources(namespace: string, listOptionsLabelSelector?: string, listOptionsFieldSelector?: string, listOptionsWatch?: boolean, listOptionsAllowWatchBookmarks?: boolean, listOptionsResourceVersion?: string, listOptionsResourceVersionMatch?: string, listOptionsTimeoutSeconds?: string, listOptionsLimit?: string, listOptionsContinue?: string, _options?: Configuration): Promise<StreamResultOfEventsourceEventSourceWatchEvent> {
        const result = this.api.eventSourceServiceWatchEventSources(namespace, listOptionsLabelSelector, listOptionsFieldSelector, listOptionsWatch, listOptionsAllowWatchBookmarks, listOptionsResourceVersion, listOptionsResourceVersionMatch, listOptionsTimeoutSeconds, listOptionsLimit, listOptionsContinue, _options);
        return result.toPromise();
    }
...
export class PromiseInfoServiceApi {
     ...
     * @param body 
     */
    public infoServiceCollectEvent(body: IoArgoprojWorkflowV1alpha1CollectEventRequest, _options?: Configuration): Promise<any> {
        const result = this.api.infoServiceCollectEvent(body, _options);
        return result.toPromise();
    }

    /**
     */
    public infoServiceGetInfo(_options?: Configuration): Promise<IoArgoprojWorkflowV1alpha1InfoResponse> {
        const result = this.api.infoServiceGetInfo(_options);
        return result.toPromise();
    }

    /**
     */
    public infoServiceGetUserInfo(_options?: Configuration): Promise<IoArgoprojWorkflowV1alpha1GetUserInfoResponse> {
        const result = this.api.infoServiceGetUserInfo(_options);
        return result.toPromise();
    }

    /**
     */
    public infoServiceGetVersion(_options?: Configuration): Promise<IoArgoprojWorkflowV1alpha1Version> {
        const result = this.api.infoServiceGetVersion(_options);
        return result.toPromise();
    }
...
export class PromiseSensorServiceApi {
     ...
     * @param body 
     */
    public sensorServiceCreateSensor(namespace: string, body: SensorCreateSensorRequest, _options?: Configuration): Promise<IoArgoprojEventsV1alpha1Sensor> {
        const result = this.api.sensorServiceCreateSensor(namespace, body, _options);
        return result.toPromise();
    }
    ...
    public sensorServiceDeleteSensor(namespace: string, name: string, deleteOptionsGracePeriodSeconds?: string, deleteOptionsPreconditionsUid?: string, deleteOptionsPreconditionsResourceVersion?: string, deleteOptionsOrphanDependents?: boolean, deleteOptionsPropagationPolicy?: string, deleteOptionsDryRun?: Array<string>, _options?: Configuration): Promise<any> {
        const result = this.api.sensorServiceDeleteSensor(namespace, name, deleteOptionsGracePeriodSeconds, deleteOptionsPreconditionsUid, deleteOptionsPreconditionsResourceVersion, deleteOptionsOrphanDependents, deleteOptionsPropagationPolicy, deleteOptionsDryRun, _options);
        return result.toPromise();
    }
     ...
     * @param getOptionsResourceVersion resourceVersion sets a constraint on what resource versions a request may be served from. See https://kubernetes.io/docs/reference/using-api/api-concepts/#resource-versions for details.  Defaults to unset +optional
     */
    public sensorServiceGetSensor(namespace: string, name: string, getOptionsResourceVersion?: string, _options?: Configuration): Promise<IoArgoprojEventsV1alpha1Sensor> {
        const result = this.api.sensorServiceGetSensor(namespace, name, getOptionsResourceVersion, _options);
        return result.toPromise();
    }
     ...
     * @param listOptionsContinue The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \&quot;next key\&quot;.  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.
     */
    public sensorServiceListSensors(namespace: string, listOptionsLabelSelector?: string, listOptionsFieldSelector?: string, listOptionsWatch?: boolean, listOptionsAllowWatchBookmarks?: boolean, listOptionsResourceVersion?: string, listOptionsResourceVersionMatch?: string, listOptionsTimeoutSeconds?: string, listOptionsLimit?: string, listOptionsContinue?: string, _options?: Configuration): Promise<IoArgoprojEventsV1alpha1SensorList> {
        const result = this.api.sensorServiceListSensors(namespace, listOptionsLabelSelector, listOptionsFieldSelector, listOptionsWatch, listOptionsAllowWatchBookmarks, listOptionsResourceVersion, listOptionsResourceVersionMatch, listOptionsTimeoutSeconds, listOptionsLimit, listOptionsContinue, _options);
        return result.toPromise();
    }
     ...
     * @param podLogOptionsInsecureSkipTLSVerifyBackend insecureSkipTLSVerifyBackend indicates that the apiserver should not confirm the validity of the serving certificate of the backend it is connecting to.  This will make the HTTPS connection between the apiserver and the backend insecure. This means the apiserver cannot verify the log data it is receiving came from the real kubelet.  If the kubelet is configured to verify the apiserver\&#39;s TLS credentials, it does not mean the connection to the real kubelet is vulnerable to a man in the middle attack (e.g. an attacker could not intercept the actual log data coming from the real kubelet). +optional.
     */
    public sensorServiceSensorsLogs(namespace: string, name?: string, triggerName?: string, grep?: string, podLogOptionsContainer?: string, podLogOptionsFollow?: boolean, podLogOptionsPrevious?: boolean, podLogOptionsSinceSeconds?: string, podLogOptionsSinceTimeSeconds?: string, podLogOptionsSinceTimeNanos?: number, podLogOptionsTimestamps?: boolean, podLogOptionsTailLines?: string, podLogOptionsLimitBytes?: string, podLogOptionsInsecureSkipTLSVerifyBackend?: boolean, _options?: Configuration): Promise<StreamResultOfSensorLogEntry> {
        const result = this.api.sensorServiceSensorsLogs(namespace, name, triggerName, grep, podLogOptionsContainer, podLogOptionsFollow, podLogOptionsPrevious, podLogOptionsSinceSeconds, podLogOptionsSinceTimeSeconds, podLogOptionsSinceTimeNanos, podLogOptionsTimestamps, podLogOptionsTailLines, podLogOptionsLimitBytes, podLogOptionsInsecureSkipTLSVerifyBackend, _options);
        return result.toPromise();
    }
     ...
     * @param body 
     */
    public sensorServiceUpdateSensor(namespace: string, name: string, body: SensorUpdateSensorRequest, _options?: Configuration): Promise<IoArgoprojEventsV1alpha1Sensor> {
        const result = this.api.sensorServiceUpdateSensor(namespace, name, body, _options);
        return result.toPromise();
    }
     ...
     * @param listOptionsContinue The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \&quot;next key\&quot;.  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.
     */
    public sensorServiceWatchSensors(namespace: string, listOptionsLabelSelector?: string, listOptionsFieldSelector?: string, listOptionsWatch?: boolean, listOptionsAllowWatchBookmarks?: boolean, listOptionsResourceVersion?: string, listOptionsResourceVersionMatch?: string, listOptionsTimeoutSeconds?: string, listOptionsLimit?: string, listOptionsContinue?: string, _options?: Configuration): Promise<StreamResultOfSensorSensorWatchEvent> {
        const result = this.api.sensorServiceWatchSensors(namespace, listOptionsLabelSelector, listOptionsFieldSelector, listOptionsWatch, listOptionsAllowWatchBookmarks, listOptionsResourceVersion, listOptionsResourceVersionMatch, listOptionsTimeoutSeconds, listOptionsLimit, listOptionsContinue, _options);
        return result.toPromise();
    }
...
export class PromiseWorkflowServiceApi {
     ...
     * @param body 
     */
    public workflowServiceCreateWorkflow(namespace: string, body: IoArgoprojWorkflowV1alpha1WorkflowCreateRequest, _options?: Configuration): Promise<IoArgoprojWorkflowV1alpha1Workflow> {
        const result = this.api.workflowServiceCreateWorkflow(namespace, body, _options);
        return result.toPromise();
    }
     ...
     * @param force 
     */
    public workflowServiceDeleteWorkflow(namespace: string, name: string, deleteOptionsGracePeriodSeconds?: string, deleteOptionsPreconditionsUid?: string, deleteOptionsPreconditionsResourceVersion?: string, deleteOptionsOrphanDependents?: boolean, deleteOptionsPropagationPolicy?: string, deleteOptionsDryRun?: Array<string>, force?: boolean, _options?: Configuration): Promise<any> {
        const result = this.api.workflowServiceDeleteWorkflow(namespace, name, deleteOptionsGracePeriodSeconds, deleteOptionsPreconditionsUid, deleteOptionsPreconditionsResourceVersion, deleteOptionsOrphanDependents, deleteOptionsPropagationPolicy, deleteOptionsDryRun, force, _options);
        return result.toPromise();
    }
     ...
     */
    public workflowServiceGetWorkflow(namespace: string, name: string, getOptionsResourceVersion?: string, fields?: string, _options?: Configuration): Promise<IoArgoprojWorkflowV1alpha1Workflow> {
        const result = this.api.workflowServiceGetWorkflow(namespace, name, getOptionsResourceVersion, fields, _options);
        return result.toPromise();
    }
     ...
     * @param body 
     */
    public workflowServiceLintWorkflow(namespace: string, body: IoArgoprojWorkflowV1alpha1WorkflowLintRequest, _options?: Configuration): Promise<IoArgoprojWorkflowV1alpha1Workflow> {
        const result = this.api.workflowServiceLintWorkflow(namespace, body, _options);
        return result.toPromise();
    }
     ...
     */
    public workflowServiceListWorkflows(namespace: string, listOptionsLabelSelector?: string, listOptionsFieldSelector?: string, listOptionsWatch?: boolean, listOptionsAllowWatchBookmarks?: boolean, listOptionsResourceVersion?: string, listOptionsResourceVersionMatch?: string, listOptionsTimeoutSeconds?: string, listOptionsLimit?: string, listOptionsContinue?: string, fields?: string, _options?: Configuration): Promise<IoArgoprojWorkflowV1alpha1WorkflowList> {
        const result = this.api.workflowServiceListWorkflows(namespace, listOptionsLabelSelector, listOptionsFieldSelector, listOptionsWatch, listOptionsAllowWatchBookmarks, listOptionsResourceVersion, listOptionsResourceVersionMatch, listOptionsTimeoutSeconds, listOptionsLimit, listOptionsContinue, fields, _options);
        return result.toPromise();
    }
     ...
     * @param selector 
     */
    public workflowServicePodLogs(namespace: string, name: string, podName: string, logOptionsContainer?: string, logOptionsFollow?: boolean, logOptionsPrevious?: boolean, logOptionsSinceSeconds?: string, logOptionsSinceTimeSeconds?: string, logOptionsSinceTimeNanos?: number, logOptionsTimestamps?: boolean, logOptionsTailLines?: string, logOptionsLimitBytes?: string, logOptionsInsecureSkipTLSVerifyBackend?: boolean, grep?: string, selector?: string, _options?: Configuration): Promise<StreamResultOfIoArgoprojWorkflowV1alpha1LogEntry> {
        const result = this.api.workflowServicePodLogs(namespace, name, podName, logOptionsContainer, logOptionsFollow, logOptionsPrevious, logOptionsSinceSeconds, logOptionsSinceTimeSeconds, logOptionsSinceTimeNanos, logOptionsTimestamps, logOptionsTailLines, logOptionsLimitBytes, logOptionsInsecureSkipTLSVerifyBackend, grep, selector, _options);
        return result.toPromise();
    }
     ...
     * @param body 
     */
    public workflowServiceResubmitWorkflow(namespace: string, name: string, body: IoArgoprojWorkflowV1alpha1WorkflowResubmitRequest, _options?: Configuration): Promise<IoArgoprojWorkflowV1alpha1Workflow> {
        const result = this.api.workflowServiceResubmitWorkflow(namespace, name, body, _options);
        return result.toPromise();
    }
     ...
     * @param body 
     */
    public workflowServiceResumeWorkflow(namespace: string, name: string, body: IoArgoprojWorkflowV1alpha1WorkflowResumeRequest, _options?: Configuration): Promise<IoArgoprojWorkflowV1alpha1Workflow> {
        const result = this.api.workflowServiceResumeWorkflow(namespace, name, body, _options);
        return result.toPromise();
    }
     ...
     * @param body 
     */
    public workflowServiceRetryWorkflow(namespace: string, name: string, body: IoArgoprojWorkflowV1alpha1WorkflowRetryRequest, _options?: Configuration): Promise<IoArgoprojWorkflowV1alpha1Workflow> {
        const result = this.api.workflowServiceRetryWorkflow(namespace, name, body, _options);
        return result.toPromise();
    }
     ...
     * @param body 
     */
    public workflowServiceSetWorkflow(namespace: string, name: string, body: IoArgoprojWorkflowV1alpha1WorkflowSetRequest, _options?: Configuration): Promise<IoArgoprojWorkflowV1alpha1Workflow> {
        const result = this.api.workflowServiceSetWorkflow(namespace, name, body, _options);
        return result.toPromise();
    }
     ...
     * @param body 
     */
    public workflowServiceStopWorkflow(namespace: string, name: string, body: IoArgoprojWorkflowV1alpha1WorkflowStopRequest, _options?: Configuration): Promise<IoArgoprojWorkflowV1alpha1Workflow> {
        const result = this.api.workflowServiceStopWorkflow(namespace, name, body, _options);
        return result.toPromise();
    }
     ...
     * @param body 
     */
    public workflowServiceSubmitWorkflow(namespace: string, body: IoArgoprojWorkflowV1alpha1WorkflowSubmitRequest, _options?: Configuration): Promise<IoArgoprojWorkflowV1alpha1Workflow> {
        const result = this.api.workflowServiceSubmitWorkflow(namespace, body, _options);
        return result.toPromise();
    }
     ...
     * @param body 
     */
    public workflowServiceSuspendWorkflow(namespace: string, name: string, body: IoArgoprojWorkflowV1alpha1WorkflowSuspendRequest, _options?: Configuration): Promise<IoArgoprojWorkflowV1alpha1Workflow> {
        const result = this.api.workflowServiceSuspendWorkflow(namespace, name, body, _options);
        return result.toPromise();
    }
     ...
     * @param body 
     */
    public workflowServiceTerminateWorkflow(namespace: string, name: string, body: IoArgoprojWorkflowV1alpha1WorkflowTerminateRequest, _options?: Configuration): Promise<IoArgoprojWorkflowV1alpha1Workflow> {
        const result = this.api.workflowServiceTerminateWorkflow(namespace, name, body, _options);
        return result.toPromise();
    }
     ...
     * @param listOptionsContinue The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \&quot;next key\&quot;.  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.
     */
    public workflowServiceWatchEvents(namespace: string, listOptionsLabelSelector?: string, listOptionsFieldSelector?: string, listOptionsWatch?: boolean, listOptionsAllowWatchBookmarks?: boolean, listOptionsResourceVersion?: string, listOptionsResourceVersionMatch?: string, listOptionsTimeoutSeconds?: string, listOptionsLimit?: string, listOptionsContinue?: string, _options?: Configuration): Promise<StreamResultOfIoK8sApiCoreV1Event> {
        const result = this.api.workflowServiceWatchEvents(namespace, listOptionsLabelSelector, listOptionsFieldSelector, listOptionsWatch, listOptionsAllowWatchBookmarks, listOptionsResourceVersion, listOptionsResourceVersionMatch, listOptionsTimeoutSeconds, listOptionsLimit, listOptionsContinue, _options);
        return result.toPromise();
    }
     ...
     * @param fields 
     */
    public workflowServiceWatchWorkflows(namespace: string, listOptionsLabelSelector?: string, listOptionsFieldSelector?: string, listOptionsWatch?: boolean, listOptionsAllowWatchBookmarks?: boolean, listOptionsResourceVersion?: string, listOptionsResourceVersionMatch?: string, listOptionsTimeoutSeconds?: string, listOptionsLimit?: string, listOptionsContinue?: string, fields?: string, _options?: Configuration): Promise<StreamResultOfIoArgoprojWorkflowV1alpha1WorkflowWatchEvent> {
        const result = this.api.workflowServiceWatchWorkflows(namespace, listOptionsLabelSelector, listOptionsFieldSelector, listOptionsWatch, listOptionsAllowWatchBookmarks, listOptionsResourceVersion, listOptionsResourceVersionMatch, listOptionsTimeoutSeconds, listOptionsLimit, listOptionsContinue, fields, _options);
        return result.toPromise();
    }
    ...
    public workflowServiceWorkflowLogs(namespace: string, name: string, podName?: string, logOptionsContainer?: string, logOptionsFollow?: boolean, logOptionsPrevious?: boolean, logOptionsSinceSeconds?: string, logOptionsSinceTimeSeconds?: string, logOptionsSinceTimeNanos?: number, logOptionsTimestamps?: boolean, logOptionsTailLines?: string, logOptionsLimitBytes?: string, logOptionsInsecureSkipTLSVerifyBackend?: boolean, grep?: string, selector?: string, _options?: Configuration): Promise<StreamResultOfIoArgoprojWorkflowV1alpha1LogEntry> {
        const result = this.api.workflowServiceWorkflowLogs(namespace, name, podName, logOptionsContainer, logOptionsFollow, logOptionsPrevious, logOptionsSinceSeconds, logOptionsSinceTimeSeconds, logOptionsSinceTimeNanos, logOptionsTimestamps, logOptionsTailLines, logOptionsLimitBytes, logOptionsInsecureSkipTLSVerifyBackend, grep, selector, _options);
        return result.toPromise();
    }
...
export class PromiseWorkflowTemplateServiceApi {
     ...
     * @param body 
     */
    public workflowTemplateServiceCreateWorkflowTemplate(namespace: string, body: IoArgoprojWorkflowV1alpha1WorkflowTemplateCreateRequest, _options?: Configuration): Promise<IoArgoprojWorkflowV1alpha1WorkflowTemplate> {
        const result = this.api.workflowTemplateServiceCreateWorkflowTemplate(namespace, body, _options);
        return result.toPromise();
    }
    ...
    public workflowTemplateServiceDeleteWorkflowTemplate(namespace: string, name: string, deleteOptionsGracePeriodSeconds?: string, deleteOptionsPreconditionsUid?: string, deleteOptionsPreconditionsResourceVersion?: string, deleteOptionsOrphanDependents?: boolean, deleteOptionsPropagationPolicy?: string, deleteOptionsDryRun?: Array<string>, _options?: Configuration): Promise<any> {
        const result = this.api.workflowTemplateServiceDeleteWorkflowTemplate(namespace, name, deleteOptionsGracePeriodSeconds, deleteOptionsPreconditionsUid, deleteOptionsPreconditionsResourceVersion, deleteOptionsOrphanDependents, deleteOptionsPropagationPolicy, deleteOptionsDryRun, _options);
        return result.toPromise();
    }
     ...
     * @param getOptionsResourceVersion resourceVersion sets a constraint on what resource versions a request may be served from. See https://kubernetes.io/docs/reference/using-api/api-concepts/#resource-versions for details.  Defaults to unset +optional
     */
    public workflowTemplateServiceGetWorkflowTemplate(namespace: string, name: string, getOptionsResourceVersion?: string, _options?: Configuration): Promise<IoArgoprojWorkflowV1alpha1WorkflowTemplate> {
        const result = this.api.workflowTemplateServiceGetWorkflowTemplate(namespace, name, getOptionsResourceVersion, _options);
        return result.toPromise();
    }
     ...
     * @param body 
     */
    public workflowTemplateServiceLintWorkflowTemplate(namespace: string, body: IoArgoprojWorkflowV1alpha1WorkflowTemplateLintRequest, _options?: Configuration): Promise<IoArgoprojWorkflowV1alpha1WorkflowTemplate> {
        const result = this.api.workflowTemplateServiceLintWorkflowTemplate(namespace, body, _options);
        return result.toPromise();
    }
     ...
     * @param body 
     */
    public workflowTemplateServiceUpdateWorkflowTemplate(namespace: string, name: string, body: IoArgoprojWorkflowV1alpha1WorkflowTemplateUpdateRequest, _options?: Configuration): Promise<IoArgoprojWorkflowV1alpha1WorkflowTemplate> {
        const result = this.api.workflowTemplateServiceUpdateWorkflowTemplate(namespace, name, body, _options);
        return result.toPromise();
    }
